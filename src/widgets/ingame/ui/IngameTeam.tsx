...
import type { SpectatorParticipant, SpectatorBannedChampion } from "@/entities/spectator";
...
export default function IngameTeam({
  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        className={`flex items-center justify-between text-sm font-bold ${teamColor} px-0 py-1.5 rounded-t-lg bg-surface-2`}
      >
        <span>{teamName}</span>
