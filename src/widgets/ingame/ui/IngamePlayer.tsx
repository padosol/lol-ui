...
export default function IngamePlayer({
  ...
  return (
    <div className="flex items-center gap-1.5 px-2 py-1 rounded border border-divider bg-surface-2 hover:bg-surface-4 transition-all shadow-md hover:shadow-lg">
      {/* 챔피언 아이콘 */}
